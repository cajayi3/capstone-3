...
import { getEvents, createEvent, updateEvent, deleteEvent } from './controller/events.controller.ts';
...
app.use((err: ErrorWithStack, req: Request, res: Response, next: Function) => {
...
app.get("/hello", query("person").notEmpty().optional(), (req, res) => {
...
app.get('/live', async (req, res) => {
    try {
        const { fetchLiveFixtures } = await import('../server/services/liveFixtures.ts');
